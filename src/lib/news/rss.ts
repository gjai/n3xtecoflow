...
const OFF_TOPIC =
  /\bsegway\b|\bxyber\b|\be-?bike\b|\btesla\b|\biphone\b|\bsamsung\b|\bplaystation\b|\bxbox\b|\bnintendo\b|\bdyson\b|\broborock\b|\becovacs\b|\bbalance\s+connect/|\bpieds?\b|\bfoot\s+massager\b|\bchaise\s+de\s+massage\b/i;
