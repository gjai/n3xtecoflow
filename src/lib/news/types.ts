...
export const NEWS_FEEDS: NewsFeed[] = [
  ...
  },
  {
    ...
    siteId: "massage-gun",
    url: "https://news.google.com/rss/search?q=(%22pistolet+de+massage%22+OR+%22massage+gun%22+OR+%22masseur+cervical%22+OR+%22masseur+shiatsu%22+OR+%22coussin+de+massage%22+OR+Theragun+OR+Therabody+OR+Hypervolt+OR+Hyperice+OR+Renpho+OR+TOLOCO+OR+Brelley+OR+AERLANG+OR+%22Bob+and+Brad%22+OR+%22r%C3%A9cup%C3%A9ration+musculaire%22)+when:30d&hl=fr&gl=FR&ceid=FR:fr",
  },
  {
    id: "massage-gun-gnews-en",
    siteId: "massage-gun",
    url: "https://news.google.com/rss/search?q=(%22massage+gun%22+OR+%22neck+massager%22+OR+%22shiatsu+massager%22+OR+Theragun+OR+Therabody+OR+Hypervolt+OR+Hyperice+OR+Renpho+OR+TOLOCO+OR+Brelley+OR+percussion+massager+OR+%22muscle+recovery%22)+when:30d&hl=en-US&gl=US&ceid=US:en",
  },
];
